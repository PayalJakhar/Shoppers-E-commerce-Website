...
app.post('/api/payment/verify', async (req, res) => {
    try {
        ...
        // Deduct 500 from both Coins and donationCount
        user.Coins -= 500;
        user.donationCount = Math.max((user.donationCount || 0) - 500, 0);
        ...
        return res.status(200).json({ 
            ...
            updatedDonationCount: user.donationCount // ✅ Send updated count
        });
    } catch (error) {
