...
const app = express();
const mongoose = require('mongoose');
const Donation = require('./models/Donation'); // Assuming Donation schema is defined in models/Donation
const Users = require('./models/Users'); // Assuming Users schema is defined in models/Users

app.use(express.json());

app.post('/donation', async (req, res) => {
  try {
    // Check whether an email account already exists
