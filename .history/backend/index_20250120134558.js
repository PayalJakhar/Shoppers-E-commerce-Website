...
app.post('/Signup', async (req,res)=>{
    ...
    //JWT Authentication refers to a method of securely verifying the identity of users and exchanging information between parties using JSON Web Tokens (JWT).
})
