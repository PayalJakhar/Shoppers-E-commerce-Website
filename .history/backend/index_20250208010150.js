...
app.post('/donation',async (req,res) =>{
    ...
    if(!check){
        return res.status(400).json({success: false, errors: "Keep your email same as your login email"});
    }
    const donations = new Donation({
        ...
        clothesDetails: req.body.clothesDetails, // Make sure this is an array of objects
        ngo: req.body.ngo, // Should contain `name`
        donationDate: req.body.donationDate, 
    })
    aawait donations.save()
})
