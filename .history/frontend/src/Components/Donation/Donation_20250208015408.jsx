    ...
    <div className="container">
      ...
      <form action="/submit-donation" method="post">
        ...
        <div className="container-in">
          ...
          <input className="inpt" value={clothes.type} onChange={(e) => handleClothesChange(index, e)} type="text" name="quantity" placeholder="Quantity" required />
          <input className="inpt" value={clothes.type} onChange={(e) => handleClothesChange(index, e)} type="text" name="damage" placeholder="Damage Percentage" required />
