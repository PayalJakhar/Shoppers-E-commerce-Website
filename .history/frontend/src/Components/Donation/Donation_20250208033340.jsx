    ...
    <div className="container">
      ...
      <form onSubmit={handleDonationSubmit}>
        ...
        <div className="container-in" key={0}>
            <select className="inpt" name="type" value={type} onChange={(e) => handleClothesChange(0, e)} required>
              <option value="">Select Type</option>
            ...
            <input className="inpt" type="text" name="quantity" placeholder="Quantity" value={quantity} onChange={(e) => handleClothesChange(0, e)} required />
