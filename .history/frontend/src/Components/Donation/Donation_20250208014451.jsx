...
const Donation = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:4000/donat", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="container-in">
          <select className="inpt" name="type" onChange={(e) => handleChange(e, 0)} required>
            <option value="">Select Type</option>
            <option value="T-shirt">T-shirt</option>
            <option value="Shirt">Shirt</option>
            <option value="Jeans">Jeans</option>
          ...
          <input className="inpt" type="text" name="quantity" placeholder="Quantity" onChange={(e) => handleChange(e, 0)} required />
          <input className="inpt" type="text" name="damage" placeholder="Damage Percentage" onChange={(e) => handleChange(e, 0)} required />
          <button className="btns" onClick={addRow}>ADD</button>
        </div>

        {rows.map((row, index) => (
          <div className="container-in" key={row.id}>
            <select className="inpt" name="type" onChange={(e) => handleChange(e, index)} required>
              <option value="">Select Type</option>
              <option value="T-shirt">T-shirt</option>
              <option value="Shirt">Shirt</option>
              <option value="Jeans">Jeans</option>
            ...
            <input className="inpt" type="text" name="quantity" placeholder="Quantity" onChange={(e) => handleChange(e, index)} required />
            <input className="inpt" type="text" name="damage" placeholder="Damage Percentage" onChange={(e) => handleChange(e, index)} required />
            <button className="btn" onClick={addRow}>ADD</button>
            <button className="btn" onClick={() => removeRow(row.id)}>X</button>
          </div>
        ))}
