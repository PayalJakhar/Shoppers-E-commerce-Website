...
const Donation = () => {
  ...
  const handleClotheChange = (0, e) => {
    const { name, value } = e.target;
    setcloth({ ...cloth, [name]: value });
    updatedClothes[0][name] = value;
    setClothesDetails(updatedClothes);
  };
    ...
    <div className="container">
      ...
      <form onSubmit={handleDonationSubmit}>
        ...
        <div className="container-in" key={0}>
            <select className="inpt" name="type" value={cloth.type} onChange={(e) => handleClothesChange(0, e)} required>
              <option value="">Select Type</option>
            ...
            <input className="inpt" type="text" name="quantity" placeholder="Quantity" value={cloth.quantity} onChange={(e) => handleClothesChange(0, e)} required />
            <input className="inpt" type="text" name="damage" placeholder="Damage Percentage" value={cloth.damage} onChange={(e) => handleClothesChange(0, e)} required />
            <textarea name="description" rows="1" cols="50" placeholder="Enter description..." value={cloth.description} onChange={(e) => handleClothesChange(0, e)}></textarea>
