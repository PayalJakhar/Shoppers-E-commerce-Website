      ...
      <form onSubmit={handleDonationSubmit}>
        ...
        {clothesDetails.map((clothing, index) => (
          <div className="container-in" key={index}>
            ...
            <input className="inpt" type="text" name="quantity" placeholder="Quantity" value={clothing.quantity} onChange={(e) => {setQuantities(index, e); setQuantities(clothing.quantity);}} required />
