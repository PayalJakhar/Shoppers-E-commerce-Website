  ...
  return (
    <div className="container">
      ...
      <form action="/submit-donation" method="post">
        ...
        <input className="inpt" value={formData.email} onChange={changeHandler} type="text" name="address" placeholder="Your Address" required />
        <input className="inpt" value={formData.email} onChange={changeHandler} type="text" name="city" placeholder="Your City" required />
        <input className="inpt" value={formData.} onChange={changeHandler} type="text" name="pincode" placeholder="Your Pincode" required />
