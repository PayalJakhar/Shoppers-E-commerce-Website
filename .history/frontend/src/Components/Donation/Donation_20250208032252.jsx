    ...
    <div className="container">
      ...
      <form onSubmit={handleDonationSubmit}>
        ...
        <div className="container-in" key={0}>
            <select className="inpt" name="type" value={clothing.type} onChange={(e) => handleClothesChange(0, e)} required>
              <option value="">Select Type</option>
              <option value="T-shirt">T-shirt</option>
              <option value="Shirt">Shirt</option>
              <option value="Jeans">Jeans</option>
            ...
            <input className="inpt" type="text" name="quantity" placeholder="Quantity" value={clothing.quantity} onChange={(e) => handleClothesChange(0, e)} required />
            <input className="inpt" type="text" name="damage" placeholder="Damage Percentage" value={clothing.damage} onChange={(e) => handleClothesChange(0, e)} required />
            <textarea name="description" rows="1" cols="50" placeholder="Enter description..." value={clothing.description} onChange={(e) => handleClothesChange(0, e)}></textarea>
            <button className="btn" type="button" onClick={addRow}>ADD</button>
            <button className="btn" type="button" onClick={() => removeRow(0)}>X</button>
          </div>
