      ...
      <form onSubmit={handleDonationSubmit}>
        ...
        {clothesDetails.map((clothing, index) => (
          <div className="container-in" key={index}>
            <select className="inpt" name="type" value={clothing.type} onChange={(e) => handleChange(e, index)} required>
              <option value="">Select Type</option>
            ...
            <input className="inpt" type="text" name="quantity" value={clothing.quantity} placeholder="Quantity" onChange={(e) => handleChange(e, index)} required />
            <input className="inpt" type="text" name="damage" value={clothing.damage} placeholder="Damage Percentage" onChange={(e) => handleChange(e, index)} required />
            ...
            <button className="btn" onClick={() => removeRow(index)}>X</button>
          </div>
        ))}
