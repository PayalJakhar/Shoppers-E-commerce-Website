    ...
    <div className="container">
      ...
      <form action="/submit-donation" method="post">
        ...
        <div className="container-in">
          ...
          <input className="inpt" value={clothes.                  value={clothes.damagePercent}
 onChange={(e) => handleClothesChange(index, e)} type="text" name="damage" placeholder="Damage Percentage" required />
