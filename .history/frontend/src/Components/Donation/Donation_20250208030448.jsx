    ...
    <div className="container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="container-in">
          ...
          <input className="inpt" type="text" name="damage" placeholder="Damage Percentage" value={clothes.type}  onChange={(e) => handleClothesChange(index, e)} required />
          <textarea name="description" rows="1" cols="50" placeholder="Enter description..." value={clothes.type}  onChange={(e) => handleClothesChange(index, e)}></textarea>
