      ...
      <form onSubmit={handleDonationSubmit}>
        ...
        {clothesDetails.map((clothing, index) => (
          <div className="container-in" key={index}>
            ...
            <input className="inpt" type="text" name="quantity" placeholder="Quantity" value={clothing.quantity} onChange={(e) => {handleClothesChange(index, e); setQuantities();}} required />
