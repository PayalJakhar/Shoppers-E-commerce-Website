  ...
  return (
    <div className="container">
      ...
      <form>
        ...
        <input className="inpt" value={formData.phoneNo} onChange={handleInputChange} type="number" name="phoneNo" placeholder="Phone Number" required />
        ...
        {clothesDetails.map((clothes, index) => (
          <div className="container-in" key={index}>
            ...
            <input className="inpt" value={clothes.damagePercent} onChange={(e) => handleClothesChange(index, e)} type="text" name="damagePercent" placeholder="Damage Percentage" required />
            ...
            <button className="btns" onClick={() => removeRow(index)}>X</button>
          </div>
        ))}
        ...
        {isOpen && (
          <div className="modal">
            <div className="modal-content">
              ...
              <input className="inpts" type="date" name="preferredDate" required />
