...
const Donation = () => {
  ...
  const [clothesDetails, setClothesDetails] = useState([{ type: "", quantity: "", damage: "" }]);
  const [formData, setFormData] = useState({
    name: "",
    email: "",
    phoneNo: "",
  ...
  return (
    <div className="container">
      ...
      <form>
        ...
        <input className="inpt" value={formData.phoneNo} onChange={handleInputChange} type="number" name="phoneNo" placeholder="Enter Phone number" required />
