    ...
    <div className="container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="container-in">
          ...
          <input className="inpt" type="text" name="quantity" placeholder="Quantity"value={clothes.type}  onChange={(e) => handleClothesChange(index, e)} required />
          <input className="inpt" type="text" name="damage" placeholder="Damage Percentage" value={clothes.damgePercentage}  onChange={(e) => handleClothesChange(index, e)} required />
