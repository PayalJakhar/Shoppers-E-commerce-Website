    ...
    <div className="container">
      ...
      <form action="/submit-donation" method="post">
        ...
        <div className="container-in">
          <select className="inpt" value={clothes.type} onChange={handleInputChange} name="type" required>
          ...
          <input className="inpt" onChange={handleInputChange} type="text" name="quantity" placeholder="Quantity" required />
          <input className="inpt" onChange={handleInputChange} type="text" name="damage" placeholder="Damage Percentage" required />
          <textarea name="description" onChange={handleInputChange} rows="1" cols="50" placeholder="Enter description..."></textarea>
