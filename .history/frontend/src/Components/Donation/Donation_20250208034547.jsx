...
const Donation = () => {
  ...
  const handleClotheChange = (e) => {
    const { name, value } = e.target;
    setCloth((prevCloth) => ({ ...prevCloth, [name]: value }));
  
    setClothesDetails((prevDetails) => {
      const updatedClothes = [...prevDetails];
      if (updatedClothes.length === 0) {
        updatedClothes.push({ type: "", quantity: "", damage: "", description: "" });
      }
      updatedClothes[0] = { ...updatedClothes[0], [name]: value };
  ...
  const handleClothesChange = (index, e) => {
    ...
    setClothesDetails((prevDetails) => {
      const updatedClothes = [...prevDetails];
      updatedClothes[index] = { ...updatedClothes[index], [name]: value };
      return updatedClothes;
    });
  };
  ...
  return (
    <div className="container">
      ...
      <form onSubmit={handleDonationSubmit}>
        ...
        <div className="container-in" key={0}>
            <select className="inpt" name="type" value={cloth.type} onChange={(e) => handleClotheChange(e)} required>
              <option value="">Select Type</option>
            ...
            <input className="inpt" type="text" name="quantity" placeholder="Quantity" value={cloth.quantity} onChange={(e) => handleClotheChange( e)} required />
            <input className="inpt" type="text" name="damage" placeholder="Damage Percentage" value={cloth.damage} onChange={(e) => handleClotheChange( e)} required />
            <textarea name="description" rows="1" cols="50" placeholder="Enter description..." value={cloth.description} onChange={(e) => handleClotheChange(e)}></textarea>
