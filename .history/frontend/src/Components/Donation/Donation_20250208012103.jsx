  ...
  return (
    <div className="container">
      ...
      <form action="/submit-donation" method="post">
        <input className="inpt" onChange={changeHandler} type="text" name="name" placeholder="Your Name" required />
        <input className="inpt" onChange={changeHandler} type="email" name="email" placeholder="Your Email" required />
        <input className="inpt" onChange={changeHandler} type="number" name="phone" placeholder="Enter Phone number" required />
        <input className="inpt" onChange={changeHandler} type="text" name="address" placeholder="Your Address" required />
        <input className="inpt" onChange={changeHandler} type="text" name="city" placeholder="Your City" required />
        <input className="inpt" onChange={changeHandler} type="text" name="pincode" placeholder="Your Pincode" required />
