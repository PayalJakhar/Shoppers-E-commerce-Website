...
export default function Navbar() {
    ...
    useEffect(() => {
        const count = parseInt(localStorage.getItem("donationCount") || "0", 10);
        setDonationCount(count);

        const handleStorageChange = () => {
            setDonationCount(parseInt(localStorage.getItem("donationCount") || "0", 10));
        };
            ...
            <div className="nav-login-cart">
                {localStorage.getItem('auth-token') ? (
                    <button onClick={() => { 
                        ...
                        localStorage.removeItem('donationCount');
                        setDonationCount(0);
