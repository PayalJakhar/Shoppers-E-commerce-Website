...
export default function Navbar() {
    ...
    <div className="nav-coin-count">{getRemainingCoins(donationCount, paymentCount)}</div>
    ...
    return (
        <div className="navbar">
            ...
            <div className="nav-coin-count">{Math.max((donationCount * 100) - (paymentCount * 500),0)}</div>
