...
export default function Navbar() {
    ...
    //     let remainingCoins = donationCount * 100;
    //     let usedPayments = 0;
    
    //     while (remainingCoins >= 500 && usedPayments < paymentCount) {
    //         remainingCoins -= 500;
    //         usedPayments++;
    //     }
    ...
    // };
    const { donationCount, verifyPayment, userEmail } = useContext(DonationContext);

const handlePayment = () => {
    verifyPayment({
        emailId: userEmail,
        razorpay_order_id: "some_order_id", 
        razorpay_payment_id: "some_payment_id", 
    ...
    return (
        <div className="navbar">
            ...
            <div className="nav-coin-count">{donationCount}</div>
