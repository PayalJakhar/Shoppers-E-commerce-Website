            ...
            <div className="cartitems-down">
                <div className="cartitems-total">
                    ...
                    <div>
                        ...
                        <div className="cartitems-total-item">
                            <p>Total Offer</p>
                            {donationCount >= 500 && <p>{donationCount >= 500 ? (getTotalCartAmount() * 0.7).toFixed(2) : getTotalCartAmount()}</p>}
                        </div>
                        <hr />
                        <div className="cartitems-total-item">
                            <h3>Total</h3>
                            <h3>${donationCount >= 500 ? (getTotalCartAmount() * 0.7).toFixed(2) : getTotalCartAmount()}</h3>
                        </div>
                    </div>
