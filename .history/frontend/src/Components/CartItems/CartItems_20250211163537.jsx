...
const CartItems = () => {
    ...
    const totalAmount = donationCount- paymentCount >= 5 ? (getTotalCartAmount() * 0.7).toFixed(2) : getTotalCartAmount();
    ...
    const handlePaymentVerify = async (data) => {
        ...
        const options = {
            ...
            handler: async (response) => {
                try {
                    response.emailId = userEmail; // Attach emailId to response
                ...
                <div className="cartitems-total">
                    ...
                    <div>
                        ...
                        <div className="cartitems-total-item">
                            ...
                            <p style={{color:'green'}}>{donationCount - paymentCount >= 5 ? '30%' : '0%'}</p>
                        </div>
                        <hr />
                        <div className="cartitems-total-item">
