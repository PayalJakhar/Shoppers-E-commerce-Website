...
export const DonationProvider = ({ children }) => {
    ...
    const updateDonationCount = (newCount) => setDonationCount(newCount);
    const updatePaymentCount = (newCount) => setPaymentCount(newCount);

    return (
        <DonationContext.Provider value={{ donationCount, paymentCount, updateDonationCount, updatePaymentCount, userEmail, setUserEmail }}>
            {children}
